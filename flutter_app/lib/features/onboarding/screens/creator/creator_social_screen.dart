...
class CreatorSocialScreen extends StatefulWidget {
  ...
  @override
  State<CreatorSocialScreen> createState() => _CreatorSocialScreenState();
}

class _CreatorSocialScreenState extends State<CreatorSocialScreen> {
  ...
  void _next() {
    ...
    context.push('/onboarding/creator/categories');
  }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Partagez vos profils pour que les marques puissent vous découvrir',
              style: GoogleFonts.inter(
                fontSize: 14,
